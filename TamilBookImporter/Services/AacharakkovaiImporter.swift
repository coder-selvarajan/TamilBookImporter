...
class AacharakkovaiImporter: BookImporter {
    var bookName: String = "ஆசாரக் கோவை"
    var book: Book
    var poemFile: String = ""
    ...
    func importPoems() -> Bool {
        ...
        for poem in poems {
            guard let number = poem["number"] as? Int,
                  ...
                  let poemType = poem["type"] as? String,
                  let poemTitle = poem["title"] as? String,
                  let poemContent = poem["poem"] as? String,
                  let explanation = poem["explanation"] as? String,
                  let commentary = poem["commentary"] as? String else {
                continue
            }
